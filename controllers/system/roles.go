...
func AddRole(ctx *gin.Context) {
	...
	if err := service.NewRoleInterface().AddRole(params); err != nil {
		global.ReturnContext(ctx).Failed("failed", err.Error())
		return
	}
...
func RolesInfo(ctx *gin.Context) {
	idStr := ctx.Param("rid")
	data, err := service.NewRoleInterface().RoleInfo(idStr)
	if err != nil {
		global.ReturnContext(ctx).Failed("failed", err.Error())
		return
	}
...
func UpdateRole(ctx *gin.Context) {
	...
	err := service.NewRoleInterface().UpdateRole(params.ID, params)
	if err != nil {
		global.ReturnContext(ctx).Failed("failed", err.Error())
		return
	}
...
func AddRelationRoleAndMenu(ctx *gin.Context) {
	...
	err := service.NewRoleInterface().AddRelationRoleAndMenu(params.MenuID, params.RoleID)
	if err != nil {
		global.ReturnContext(ctx).Failed("failed", err.Error())
		return
	}
...
func DelRole(ctx *gin.Context) {
	...
	err := service.NewRoleInterface().DelRole(params.RoleID)
	if err != nil {
		global.ReturnContext(ctx).Failed("failed", err.Error())
		return
	}
...
func ListRole(ctx *gin.Context) {
	data, err := service.NewRoleInterface().RoleList()
	if err != nil {
		global.ReturnContext(ctx).Failed("failed", err.Error())
		return
	}
